...
// 全局存储当前参与者ID，页面DOM加载完成后赋值
let currentPID = "";

// ====================== 改造：手动输入参与者ID，和问卷编号统一 ======================
// 修复Github Pages线上不弹窗问题：等待页面DOM完全渲染后再执行输入弹窗
...
window.addEventListener('beforeunload', function () {
    ...
    const log = {
        participantID: currentPID, // 绑定用户手动填写的ID
...
// 记录放弃购物车行为（携带手动输入的Participant ID）
